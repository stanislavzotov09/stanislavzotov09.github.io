<?php
/*
Template Name: Card - Product Card (Left)
*/
?>
<section id="section-<?php echo basename(get_permalink()); ?>" data-name="<?php the_title(); ?>" class="col-fixed-normal section_double-box">

	<div class="section section-card section-card-product section-card-product--left col-content">
					...
					<div class="col-content">
						...
						<div class="main-carousel">
						  <div class="carousel-cell" data-aos="zoom-in">
						  	<img src="<?php echo get_stylesheet_directory_uri()."/_/img/cloud-store.svg" ?>">
							<h4><?php echo get_field("burlb_1"); ?></h4>
							<p><?php echo get_field("sub_burlb_1"); ?></p>
						  </div>
						  <div class="carousel-cell" data-aos="zoom-in">
						  	<img src="<?php echo get_stylesheet_directory_uri()."/_/img/lightning-fast-seach.svg" ?>">
							<h4><?php echo get_field("burlb_2"); ?></h4>
							<p><?php echo get_field("sub_burlb_2"); ?></p>
						  </div>
						  <div class="carousel-cell" data-aos="zoom-in">
						  	<img src="<?php echo get_stylesheet_directory_uri()."/_/img/share-and-track.svg" ?>">
